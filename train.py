...
def train(model, optimizer, train_dl, val_dl, loss_fn, epoch_n, scheduler=None, start_epoch = None, metric_fns = {}, wandb = None, config_name = None, save_interval = sys.maxsize):
