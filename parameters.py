...
LOCATIONS = {
    0: 1,  # Los Angeles, USA (first area)
    1: 1,  # Los Angeles, USA (second area)
    2: 1,  # Los Angeles, USA (third area)
    3: 1,  # Chicago, USA
    4: 1,  # Houston, USA
    5: 1,  # Phoenix, USA
    6: 1,  # Philadelphia, USA (first area)
    7: 1,  # Philadelphia, USA (second area)
    8: 1,  # San Francisco, USA (first area)
    9: 1,  # San Francisco, USA (second area)
    10: 1,  # Boston, USA
    11: 1,  # Tokyo, Japan
    12: 1,  # New York City, USA
    13: 0.1,  # Sao Paulo, Brazil
    14: 0.1,  # Moscow, Russia
    15: 1,  # Paris, France
    16: 1,  # Zurich, Switzerland
    17: 1,  # London, United Kingdom
    18: 1,  # Berlin, Germany
    19: 1, # San Diego, California
    20: 1, # Miami, Florida
    21: 1, # Seattle, Washington
    22: 1, # Atlanta, Georgia
    23: 1 # Las Vegas, Nevada
}